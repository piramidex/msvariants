...
/**
 * Test case for class \Piramidex\Msvariants\Domain\Model\VariantsAttributesOrders.
 *
 ...
 */
class VariantsAttributesOrdersTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	/**
	 * @var \Piramidex\Msvariants\Domain\Model\VariantsAttributesOrders
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = new \Piramidex\Msvariants\Domain\Model\VariantsAttributesOrders();
	}
	 ...
	 * @test
	 */
	public function getOptionNameReturnsInitialValueForString() {
		$this->assertSame(
			'',
			$this->subject->getOptionName()
		);
	}
	 ...
	 * @test
	 */
	public function setOptionNameForStringSetsOptionName() {
		$this->subject->setOptionName('Conceived at T3CON10');
	 ...
	 * @test
	 */
	public function getOptionValueNameReturnsInitialValueForString() {
		$this->assertSame(
			'',
			$this->subject->getOptionValueName()
		);
	}
	 ...
	 * @test
	 */
	public function setOptionValueNameForStringSetsOptionValueName() {
		$this->subject->setOptionValueName('Conceived at T3CON10');
